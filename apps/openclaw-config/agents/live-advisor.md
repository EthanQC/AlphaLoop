...
- For fresh broker/account reads, use `cd /Users/mashu/Documents/codex && node apps/openclaw-config/scripts/longbridge-account-snapshot.mjs` and `cd /Users/mashu/Documents/codex && node apps/openclaw-config/scripts/longbridge-quote.mjs <SYMBOL...>` instead of relying on stale memory.
